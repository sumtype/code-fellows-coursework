...
SpaceShooter.Star.prototype.update = function () {
  ...
  if (this.object.position.y > SpaceShooter.settings.height) this.reset();
};
...
SpaceShooter.Explosion.prototype.reset = function () {
  ...
  for (var i = 0; i < this.object.children.length; i++) this.object.children[i].reset();
};
SpaceShooter.Explosion.prototype.play = function (color) {
  this.object.visible = true;
  for (var i = 0; i < this.children.length; i++) {
    this.children[i].object.visible = true;
    if (color != null) this.children[i].setColor(color);
    this.children[i].object.position = this.object.position;
  }
};
SpaceShooter.ExplosionBasic = function () {
  SpaceShooter.Explosion.call(this);
  this.textures = ['expl1-001.png', 'expl1-002.png', 'expl1-003.png', 'expl1-004.png', 'expl1-005.png', 'expl1-006.png', 'expl1-007.png', 'expl1-008.png', 'expl1-009.png', 'expl1-010.png', 'expl1-011.png', 'expl1-012.png', 'expl1-013.png', 'expl1-014.png', 'expl1-015.png', 'expl1-016.png', 'expl1-017.png', 'expl1-018.png', 'expl1-019.png', 'expl1-020.png', 'expl1-021.png', 'expl1-022.png', 'expl1-023.png', 'expl1-024.png', 'expl1-025.png', 'expl1-026.png', 'expl1-027.png', 'expl1-028.png', 'expl1-029.png', 'expl1-030.png', 'expl1-031.png', 'expl1-032.png', 'expl1-033.png', 'expl1-034.png', 'expl1-035.png', 'expl1-036.png'];
...
SpaceShooter.Sparkles.prototype.update = function (time) {
  ...
  for (var i = 0; i < this.object.children.length; i++) {
    ...
    if (this.object.children[i].alpha < .2) this.reset();
  }
};
...
SpaceShooter.TextScore.prototype.update = function(time) {
  ...
  if (this.displayScore == SpaceShooter.score) return;
...
SpaceShooter.Bonus.prototype.update = function(time) {
  ...
  if (update != false) this.object.position.y += 0.5;
  var date = new Date();
  var milliseconds = 0.5 + (Math.abs((500 - date.getMilliseconds())/2) / 500);
  this.object.scale.x = this.object.scale.y = milliseconds;
  if (this.object.position.y > (renderer.height + this.object.height)) this.object.visible = false;
};
...
SpaceShooter.BonusGun.prototype.collision = function (target) {
  if (target.name == 'ship') {
    ...
    if (target.bulletLevel < 5) target.bulletLevel++;
  }
